...
function phpMySQLAutoBackup ($db_server, $db, $mysql_username, $mysql_password) {
	...
	$time_internal=0;// 30 = seconds - only allow backup to run once each 30 seconds
	...
	// ---------------------------------------------------------
	include_once(LOCATION."phpmysqlautobackup.php");
}
